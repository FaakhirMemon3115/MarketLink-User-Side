        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PickupSlots_Farmers_FarmerId",
                        column: x => x.FarmerId,
                        principalTable: "Farmers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PickupSlots_Markets_MarketId",
                        column: x => x.MarketId,
                        principalTable: "Markets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockQuantityKg = table.Column<int>(type: "int", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StockKg = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    AvailableQuantities = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableQuantityKg = table.Column<int>(type: "int", nullable: false),
                    PricePerKg = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_Farmers_FarmerId",
                        column: x => x.FarmerId,
                        principalTable: "Farmers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    QuantityKg = table.Column<int>(type: "int", nullable: false),
                    PricePerKgSnapshot = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FarmerResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FarmerMarkets_FarmerId_MarketId",
                table: "FarmerMarkets",
                columns: new[] { "FarmerId", "MarketId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_FarmerId",
                table: "Inventories",
                column: "FarmerId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_ProductId_FarmerId_WeekNumber_Year",
                table: "Inventories",
                columns: new[] { "ProductId", "FarmerId", "WeekNumber", "Year" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PickupSlots_FarmerId",
                table: "PickupSlots",
                column: "FarmerId");

            migrationBuilder.CreateIndex(
                name: "IX_PickupSlots_MarketId",
                table: "PickupSlots",
                column: "MarketId");
